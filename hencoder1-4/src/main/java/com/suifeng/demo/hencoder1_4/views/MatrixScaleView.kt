...
class MatrixScaleView: View {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.save()
        mMatrix.reset()
        mMatrix.postScale(1.3f, 1.3f, point1.x + bitmapWidth / 2f, point1.y + bitmapHeight / 2f)
        ...
        canvas?.save()
        mMatrix.reset()
        mMatrix.postScale(0.6f, 1.6f, point2.x + bitmapWidth / 2f, point2.y + bitmapHeight / 2f)
        canvas?.concat(mMatrix)
