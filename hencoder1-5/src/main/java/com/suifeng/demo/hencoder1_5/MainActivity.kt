package com.suifeng.demo.hencoder1_5
...
import com.suifeng.demo.hencoder1_5.fragments.ViewFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initFragments() {
        mTitles.add("AfterOnDraw")
        mTitles.add("BeforeOnDraw")
        mTitles.add("OnDrawLayout")
        mTitles.add("DispatchDrawLayout")
        mTitles.add("AfterOnDrawForeground")
        mTitles.add("BeforeOnDrawForeground")
