...
import com.suifeng.demo.hencoder1_6.puzzle.ImagePiece;
...
public class Utils {
     ...
     * @return
     */
    public static ArrayList<ImagePiece> splitImage(Context context, Bitmap bitmap, int count, int gameMode) {

        ArrayList<ImagePiece> imagePieces = new ArrayList<>();
